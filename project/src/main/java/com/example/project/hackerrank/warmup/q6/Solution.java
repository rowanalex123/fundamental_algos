package com.example.project.hackerrank.warmup.q6;
...
public class Solution {
    ...
    private void run() throws Exception {
        ...
        for (int i = 1; i <= height; i++) {
            String space = IntStream.rangeClosed(1, height - i).mapToObj(o -> " ").reduce("", (a, b) -> a + b);
            String chars = IntStream.rangeClosed(1, i).mapToObj(o -> "#").reduce("", (a, b) -> a + b);
            op.out(space + chars);
        }
    }
