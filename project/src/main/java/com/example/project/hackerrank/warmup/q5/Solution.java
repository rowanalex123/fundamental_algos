package com.example.project.hackerrank.warmup.q5;
...
public class Solution {
    ...
    private void run() throws Exception {
        ...
        System.out.println(Solution.class.getResource(".").getPath());
        ...
        op.out("{}", df.format(pos / (double) cnt));
        op.out("{}", df.format(neg / (double) cnt));
        op.out("{}", df.format(zero / (double) cnt));
